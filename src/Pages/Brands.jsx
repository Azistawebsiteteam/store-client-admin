                                    ...
                                    <tbody>
                                        {brands.map((each, i) => (
                                            <tr className="item" key={i}>
                                                <td>{i + 1}</td>
                                                <td><img className="brandThumbnail" src={each.azst_brand_logo} alt={each.azst_brand_id} /></td>
                                                <td>{each.azst_brand_name}</td>
                                                <td><MdDelete className='icons' onClick={() => deleteBrand(each.azst_brands_id)} /> <Link to={`/edit-brand/${each.azst_brands_id}`}><MdModeEditOutline className='icons' /></Link></td>
                                            </tr>
                                        ))}
                                    </tbody>
                                </table>
