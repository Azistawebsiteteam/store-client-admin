        ...
        <div className='adminLoginPage'>
            ...
            <form onSubmit={handleLoginSubmit}>
                <div className="form-group">
                    ...
                    <input type="text" className="form-control" id="userName" value={inputValues.username} onChange={handleOnChangeInput} placeholder='UserID' />
                </div>
                <div className="form-group passwordField">
                    <label htmlFor="password">Password</label>
                    <input type={hidePassword ? "password" : "text"} autoComplete="off" className="form-control passwordInput" id="password" placeholder="Password" value={inputValues.password} onChange={handleOnChangeInput} />
