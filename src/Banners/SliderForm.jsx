            ...
            <div className="col-sm-4">
              <div className="bgStyle">
                ...
                <div>
                  <input
                    ...
                    onChange={handleImgDetails}
                  />
                  <label className="radioBtnStylings" htmlFor="publishNow">
                    Publish Now
                  </label>
                </div>
                <div>
                  <input
                    ...
                    onChange={handleImgDetails}
                  />
                  <label className="radioBtnStylings" htmlFor="schedulePublish">
                    Schedule Publish
                  </label>
                </div>
                <p className="infoTxt mb-3 mt-3">
                  In summary, "Publish Now" ensures immediate availability,
                  while "Schedule Publish" allows you to plan and release your
                  content at a later, predetermined time.
                </p>
                  ...
                  <div className="schedulevisbilty">
                    <div className="form-group">
                      ...
                      <input
                        ...
                        className="form-control"
                        min={today}
                        max={moment(imgDetails.endTime).format(
                          "YYYY-MM-DDTHH:mm"
                        )}
                    ...
                    <div className="form-group mt-3">
                      ...
                      <input
                        ...
                        type="datetime-local"
                        className="form-control"
                        min={moment(imgDetails.startTime).format(
                          "YYYY-MM-DDTHH:mm"
                        )}
                        value={moment(imgDetails.endTime).format(
                          "YYYY-MM-DDTHH:mm"
                        )}
                        onChange={handleImgDetails}
                      />
              ...
              <div className="bgStyle">
                ...
                <p className="infoTxt mt-3">
                  In summary "Background Link" refers to url of background
                  images in slider section, while "Buttons" refers to buttons
                  which appear on slider.
                </p>
              </div>
            </div>
            <hr style={{ color: "grey" }} />
